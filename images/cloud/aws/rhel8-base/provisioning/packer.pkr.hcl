...
build {
  ...
  provisioner "file" {
    ...
    source      = "${path.root}/images/cloud/aws/rhel8-base/provisioning/scripts/install.sh"
  }

  provisioner "file" {
    destination = "/tmp/nginx.conf"
    source      = "${path.root}/images/cloud/aws/rhel8-base/provisioning/scripts/nginx.conf.tmpl"
  }
